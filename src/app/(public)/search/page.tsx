...
export const metadata: Metadata = {
  ...
  description:
    "Search every bake on the Ayoob Bakery board — coconut puffs, shortbread, cream horns, braided bread and more, fresh from the Dandenong North oven every morning.",
